...
void main() {
  ...
  group('AppSearchBar', () {
    testWidgets('renders hintText, leading search icon, and toggles clear button on input', (tester) async {
      String typedText = '';
    ...
    testWidgets('updates correctly when controller changes in didUpdateWidget', (tester) async {
