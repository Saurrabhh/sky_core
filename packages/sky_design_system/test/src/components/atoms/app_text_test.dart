...
void main() {
  ...
  group('AppText', () {
    testWidgets('renders all constructors correctly with appropriate text styles', (tester) async {
      ...
      final Text displayLargeText = tester.widget<Text>(find.text('displayLarge'));
